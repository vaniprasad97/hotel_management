...
useEffect(() => {
axios
.get("https://crudcrud.com/api/61fadd5a488b4f12b850db04d2674967/hotels")
.then((response) => {
...
baseURL: "https://crudcrud.com/api/61fadd5a488b4f12b850db04d2674967",
});
...
//Function to find total no: of pages and whenever clicks the button its page number
...
const validateForm = () => {
  let errors = {};
  if ((newHotel.name.trim() === "") || (newHotel.description.trim() === "") || 
  (newHotel.location.trim() === "") )  {
    errors.name = "Name, Location and description can't be empty!! Please fill all the details..";
  }
  return errors; 
};
